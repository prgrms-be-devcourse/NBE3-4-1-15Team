...
public class MemberControllerTest {
    ...
    void t3() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.msg").value("해당 email은 이미 사용중입니다."));
    }
    ...
    void t4() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.data.refresh-token").value(member.getRefreshToken()))
                .andExpect(jsonPath("$.data.access-token").exists());
