...
interface Product {
    ...
    description: string;
    productType: string;
    sellerId: number; // 백엔드에서 내려준다고 가정
}
...
export default function HomePage() {
    ...
    // memberId 상태 변수 선언: 로그인한 사용자의 id를 저장하는 변수
        ...
        <div style={styles.container}>
            ...
            <div style={styles.leftPane}>
                ...
                {products.map((product) => {
                    // memberId와 sellerId 비교
                    const isOwner = product.sellerId === memberId;
                    console.log(
                        `[DEBUG] productId=${product.id}, sellerId=${product.sellerId}, memberId=${memberId}, isOwner=${isOwner}`
                    );
                    return (
                        ...
                        {Object.entries(cart).map(([pid, qty]) => {
                            ...
                            return (
                                <div key={pid} style={styles.cartItem}>
                                    ...
                                    <button onClick={() => removeOneFromCart(product.id)} style={styles.deleteButton}>
                                        삭제
                                    </button>
                                </div>
                            );
